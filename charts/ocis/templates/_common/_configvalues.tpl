...
{{- define "secrets.invitationsKeycloakClientSecret" -}}
{{ required "invitationsKeycloakClientSecretRef can't be autogenerated" .Values.secretRefs.invitationsKeycloakClientSecretRef | quote }}
{{- end -}}
