...
{{- define "secrets.storagePubliclinkStore" -}}
{{ required "storagepubliclinkStoreSecretRef can't be autogenerated" .Values.secretRefs.storagepubliclinkStoreSecretRef | quote }}
{{- end -}}
