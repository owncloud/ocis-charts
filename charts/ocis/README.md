...
| `insecure.ocisHttpApiInsecure`                             | disables ssl certificate checking for connections to the oCIS http apis. Not recommended for production setups                   | `false`                                                            |
| `insecure.oidcIdpInsecure`                                 | disables ssl certificate checking for connections to the openID connect identity provider. Not recommended for production setups | `false`                                                            |
