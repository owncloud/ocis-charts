...
> **Note:** TUS uploads use a separate endpoint with their own timeout handling and are not affected by these settings. The long timeouts are specifically for traditional WebDAV requests.
